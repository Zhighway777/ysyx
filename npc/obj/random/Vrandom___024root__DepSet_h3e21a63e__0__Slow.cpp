...
VL_ATTR_COLD void Vrandom___024root___eval_initial__TOP(Vrandom___024root* vlSelf);
...
VL_ATTR_COLD void Vrandom___024root___eval_initial(Vrandom___024root* vlSelf) {
    ...
    // Body
    Vrandom___024root___eval_initial__TOP(vlSelf);
...
VL_ATTR_COLD void Vrandom___024root___eval_initial__TOP(Vrandom___024root* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vrandom__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vrandom___024root___eval_initial__TOP\n"); );
    // Body
    vlSelf->random__DOT__Q = 1U;
    vlSelf->random__DOT__left_in = 0U;
}
...
#endif
                VL_FATAL_MT("vsrc/random.v", 1, "", "Settle region did not converge.");
            }
...
VL_ATTR_COLD void Vrandom___024root___ctor_var_reset(Vrandom___024root* vlSelf) {
    ...
    vlSelf->rand_num = VL_RAND_RESET_I(8);
    vlSelf->random__DOT__left_in = VL_RAND_RESET_I(1);
    vlSelf->random__DOT__Q = VL_RAND_RESET_I(8);
