...
Vencoder83::Vencoder83(VerilatedContext* _vcontextp__, const char* _vcname__)
    ...
    , vlSymsp{new Vencoder83__Syms(contextp(), _vcname__, this)}
    , en{vlSymsp->TOP.en}
    , x{vlSymsp->TOP.x}
    , y{vlSymsp->TOP.y}
    , rootp{&(vlSymsp->TOP)}
...
Vencoder83::Vencoder83(const char* _vcname__)
    : Vencoder83(Verilated::threadContextp(), _vcname__)
{
}
...
#endif  // VL_DEBUG
void Vencoder83___024root___eval_static(Vencoder83___024root* vlSelf);
...
void Vencoder83::eval_step() {
    ...
    if (VL_UNLIKELY(!vlSymsp->__Vm_didInit)) {
        ...
        Vencoder83___024root___eval_static(&(vlSymsp->TOP));
...
//============================================================
// Events and timing
bool Vencoder83::eventsPending() { return false; }

uint64_t Vencoder83::nextTimeSlot() {
...
void Vencoder83___024root___eval_final(Vencoder83___024root* vlSelf);

VL_ATTR_COLD void Vencoder83::final() {
    Vencoder83___024root___eval_final(&(vlSymsp->TOP));
}

//============================================================
// Implementations of abstract methods from VerilatedModel

const char* Vencoder83::hierName() const { return vlSymsp->name(); }
const char* Vencoder83::modelName() const { return "Vencoder83"; }
unsigned Vencoder83::threads() const { return 1; }
std::unique_ptr<VerilatedTraceConfig> Vencoder83::traceConfig() const {
...
void Vencoder83___024root__trace_init_top(Vencoder83___024root* vlSelf, VerilatedVcd* tracep);
...
VL_ATTR_COLD static void trace_init(void* voidSelf, VerilatedVcd* tracep, uint32_t code) {
    ...
    Vencoder83___024root__trace_init_top(vlSelf, tracep);
...
VL_ATTR_COLD void Vencoder83::trace(VerilatedVcdC* tfp, int levels, int options) {
    if (tfp->isOpen()) {
        vl_fatal(__FILE__, __LINE__, __FILE__,"'Vencoder83::trace()' shall not be called after 'VerilatedVcdC::open()'.");
    }
    if (false && levels && options) {}  // Prevent unused
    tfp->spTrace()->addModel(this);
    tfp->spTrace()->addInitCb(&trace_init, &(vlSymsp->TOP));
    Vencoder83___024root__trace_register(&(vlSymsp->TOP), tfp->spTrace());
}
